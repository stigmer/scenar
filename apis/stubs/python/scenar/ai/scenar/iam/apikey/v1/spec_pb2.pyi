...
class ApiKeySpec(_message.Message):
    ...
    never_expires: bool
    def __init__(self, key_hash: _Optional[str] = ..., fingerprint: _Optional[str] = ..., expires_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., never_expires: bool = ...) -> None: ...
