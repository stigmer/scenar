...
func (x *IdentityAccounts) Reset() {
	*x = IdentityAccounts{}
	mi := &file_ai_scenar_iam_identityaccount_v1_io_proto_msgTypes[0]
...
func (*IdentityAccounts) Descriptor() ([]byte, []int) {
	return file_ai_scenar_iam_identityaccount_v1_io_proto_rawDescGZIP(), []int{0}
}
...
var File_ai_scenar_iam_identityaccount_v1_io_proto protoreflect.FileDescriptor
...
const file_ai_scenar_iam_identityaccount_v1_io_proto_rawDesc = "" +
	...
	"\x13identity_account_id\x18\x01 \x01(\tR\x11identityAccountId\x123\n" +
	"\x04page\x18\x02 \x01(\v2\x1f.ai.scenar.commons.rpc.PageInfoR\x04page\"\x84\x01\n" +
	"\x14IdentityAccountsList\x12\x1f\n" +
	"\vtotal_pages\x18\x01 \x01(\x05R\n" +
	"totalPages\x12K\n" +
	"\aentries\x18\x02 \x03(\v21.ai.scenar.iam.identityaccount.v1.IdentityAccountR\aentries\"\\\n" +
	"\x13ListWithIdentityOrg\x12\x10\n" +
	"\x03org\x18\x01 \x01(\tR\x03org\x123\n" +
	"\x04page\x18\x02 \x01(\v2\x1f.ai.scenar.commons.rpc.PageInfoR\x04page\"\xc1\x01\n" +
	"\x11ExternalSubLookup\x12\x18\n" +
	"\x03org\x18\x01 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x03org\x12g\n" +
	"\x15identity_provider_ref\x18\x02 \x01(\v23.ai.scenar.commons.apiresource.ApiResourceReferenceR\x13identityProviderRef\x12)\n" +
	"\fexternal_sub\x18\x03 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\vexternalSub\"\xc6\x02\n" +
	...
	"\x0edelete_account\x18\x04 \x01(\bR\rdeleteAccountB\xb0\x02\n" +
	"$com.ai.scenar.iam.identityaccount.v1B\aIoProtoP\x01ZZgithub.com/stigmer/scenar/apis/stubs/go/ai/scenar/iam/identityaccount/v1;identityaccountv1\xa2\x02\x04ASII\xaa\x02 Ai.Scenar.Iam.Identityaccount.V1\xca\x02 Ai\\Scenar\\Iam\\Identityaccount\\V1\xe2\x02,Ai\\Scenar\\Iam\\Identityaccount\\V1\\GPBMetadata\xea\x02$Ai::Scenar::Iam::Identityaccount::V1b\x06proto3"

var (
	file_ai_scenar_iam_identityaccount_v1_io_proto_rawDescOnce sync.Once
	file_ai_scenar_iam_identityaccount_v1_io_proto_rawDescData []byte
)

func file_ai_scenar_iam_identityaccount_v1_io_proto_rawDescGZIP() []byte {
	file_ai_scenar_iam_identityaccount_v1_io_proto_rawDescOnce.Do(func() {
		file_ai_scenar_iam_identityaccount_v1_io_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ai_scenar_iam_identityaccount_v1_io_proto_rawDesc), len(file_ai_scenar_iam_identityaccount_v1_io_proto_rawDesc)))
	})
...
func file_ai_scenar_iam_identityaccount_v1_io_proto_init() {
	if File_ai_scenar_iam_identityaccount_v1_io_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_ai_scenar_iam_identityaccount_v1_io_proto_goTypes,
		DependencyIndexes: file_ai_scenar_iam_identityaccount_v1_io_proto_depIdxs,
		MessageInfos:      file_ai_scenar_iam_identityaccount_v1_io_proto_msgTypes,
	}.Build()
	File_ai_scenar_iam_identityaccount_v1_io_proto = out.File
	file_ai_scenar_iam_identityaccount_v1_io_proto_goTypes = nil
	file_ai_scenar_iam_identityaccount_v1_io_proto_depIdxs = nil
}
